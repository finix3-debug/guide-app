...
import { ChevronLeft, ClipboardList, FileText, Download } from "lucide-react";
    ...
    >
      ...
      <div className="pt-16 px-8 pb-8 flex items-center justify-between z-20 border-b border-white/5 bg-black/50 backdrop-blur-xl shadow-2xl">
        ...
        <div className="flex flex-col items-end">
          <div className="flex items-center gap-3">
            <ClipboardList className="text-cyan-500 w-6 h-6" />
            <h2 className="text-2xl font-serif font-bold text-white tracking-widest uppercase text-right">
              Protocoles <br />
              <span className="text-lg">d'Examen</span>
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10 bg-gradient-to-b from-black via-zinc-950 to-black">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <FileText size={20} />
            <span className="font-serif font-medium text-lg text-center leading-tight">Accéder aux Protocoles PDF</span>
